   ...
   return (
      <View className=" min-h-screen bg-primary">
         ...
         <View className="flex-1 justify-center">   
            <Text className=" text-3xl font-extrabold text-center text-white mt-8">Welcome</Text>
            <Text className=" text-2xl font-extrabold text-center text-white mt-4">to</Text>
            <Text className=" font-extrabold text-center text-white text-6xl my-4">TicketPay</Text>
            <Text className=" font-medium text-center text-lg text-white mb-4">Register to continue</Text>
