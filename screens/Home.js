   ...
   return (
      <View>
         <View className="flex-1 flex-col items-center space-y-1 pt-4  px-3  ">
            ...
            <View className=" flex-row items-center bg-white rounded-2xl w-full p-4 mb-4 mx-4 shadow-sm">
            ...
            <View className="flex-row justify-between items-center bg-[#5C54AD] w-full p-4 mb-4 rounded-2xl " >
