...
const Pay = () => {
   return (
      <ScrollView style={tw`flex-col h-full bg-white pb-8`}>
         <View style={tw` flex-col justify-between bg-[#6c63ff] p-4 rounded-b-[40px] h-[336px]`}>
            ...
            <Text style={tw`text-center text-white mt-4 mb-3`}>You have a total of 10 tickets</Text>

         </View>

         
         <View style={tw` flex-row flex-wrap justify-center mt-2 px-4`} className="grid grid-cols-5 grid-rows-5 gap-8">
            ...
            <TouchableOpacity style={tw` mt-4 w-full bg-[#6c63ff] flex-row justify-center rounded-xl py-4`}>
               <Text style={tw`text-white font-bold `}>Pay tickets</Text>
            </TouchableOpacity>
