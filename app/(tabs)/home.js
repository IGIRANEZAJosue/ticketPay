   ...
   return (
      <ScrollView>
         <View className="flex-1 flex-col items-center space-y-1 pt-4 px-3 min-h-screen ">
            <Text className="text-4xl font-extrabold text-primary my-6 ">
               TicketPay
            </Text>
            ...
            <View className="flex-row justify-between items-center bg-primary w-full p-4 mb-4 rounded-2xl ">
               <View className=" space-y-1 ">
                  <Text className="text-white/80 text-[20px] font-bold ">
                     Total in tickets
                  </Text>
                  <Text className="text-white font-black text-[48px]">
                     175,000
                  </Text>
